...
ActiveRecord::Schema.define(:version => 20130604095453) do
  ...
  create_table "package_pois", :force => true do |t|
    t.integer  "package_id"
    t.integer  "poi_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  add_index "package_pois", ["package_id"], :name => "index_package_pois_on_package_id"
  add_index "package_pois", ["poi_id"], :name => "index_package_pois_on_poi_id"
